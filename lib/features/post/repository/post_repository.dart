...
import 'package:redite_clone/core/constants/firebase_constant.dart';
import 'package:redite_clone/core/failure.dart';
import 'package:redite_clone/core/typ_def.dart';
...
final postRepositoryProvider = Provider((ref) {
  return PostRopository(firestore: ref.watch(firestoreProvider));
});

class PostRopository {
  final FirebaseFirestore _firestore;
  PostRopository({required FirebaseFirestore firestore})
